...
const items = [
  ...
  { id: 2, title: 'Real aestate website', links: "https://paulestate.netlify.app/", image: realvest, description: 'A responsive real estate website, worked with local Json, Routse, Formik, Params and props.' },
          ...
          {getVisibleItems().map((item) => (
            ...
            <div class="card " style={{ width: "23rem" }}>
              ...
              <a style={{
                ...
                textDecoration: 'none',
                fontWeight: 'bold',
              }} className=' card-footer resumebtn ' href={item.links} target='_blank' rel="noopener noreferrer">
                Review Project
              </a>
